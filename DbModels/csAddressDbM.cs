...
namespace DbModels
{
    public class csAddressDbM : csAddress, ISeed<csAddressDbM>, IEquatable<csAddressDbM>
    {
        ...
        public override List<IPerson> Person { get => PersonDbMs?.ToList<IPerson>(); set => new NotImplementedException(); }
        ...
        public csAddressDbM UpdateFromDTO(csLocationsCUdto org)
        {
        ...
        #region constructors
        public csAddressDbM() { }
        public csAddressDbM(csLocationsCUdto org)
        {
